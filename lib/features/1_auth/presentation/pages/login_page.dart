...
// Asumo que AppState y AppRoutePath están definidos en algún lugar de tu core
// Si no, ajusta la importación correspondiente
// import 'ruta_a_tu_app_state.dart'; 
...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // y así se vea el degradado detrás.
    ...
    return ChangeNotifierProvider(
      ...
      child: Scaffold(
        ...
        // 2. Usamos un Container con el Degradado Radial
        body: Container(
